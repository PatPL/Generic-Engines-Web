...
function Debug_AppendRandomWernherEngine(year) {
...
(function (EngineCycle) {
    EngineCycle[EngineCycle["GasGenerator"] = 0] = "GasGenerator";
    EngineCycle[EngineCycle["AuxiliaryGasGenerator"] = 1] = "AuxiliaryGasGenerator";
    EngineCycle[EngineCycle["OxidiserStagedCombustion"] = 2] = "OxidiserStagedCombustion";
    EngineCycle[EngineCycle["FuelStagedCombustion"] = 3] = "FuelStagedCombustion";
    EngineCycle[EngineCycle["FullStagedCombustion"] = 4] = "FullStagedCombustion";
    EngineCycle[EngineCycle["PressureFed"] = 5] = "PressureFed";
    EngineCycle[EngineCycle["Thruster"] = 6] = "Thruster";
    EngineCycle[EngineCycle["OpenExpander"] = 7] = "OpenExpander";
    EngineCycle[EngineCycle["ClosedExpander"] = 8] = "ClosedExpander";
    EngineCycle[EngineCycle["TapOff"] = 9] = "TapOff";
    EngineCycle[EngineCycle["Electric"] = 10] = "Electric";
...
class FunctionRandom {
    constructor(funcBias, leftFunction, rightFunction) {
        this.funcBias = funcBias;
        this.leftFunction = leftFunction;
        this.rightFunction = rightFunction;
    }
    Get(...args) {
...
class WernherHelper {
    static RegularYearCostMultiplier(year) {
        return 60 / (year - 1880) + 0.4;
    }
    static EarlyYearCostMultiplier(year) {
